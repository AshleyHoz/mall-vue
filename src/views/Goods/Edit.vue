<template>
	<el-card class="box-card">ID:{{$route.params.id}}
		...
		<el-form ref="form" :rules="rules" :model="form" label-width="80px">
			...
			<el-form-item label="商品卖点" prop="hotPoint">
				<el-input v-model="form.hotPoint" placeholder="请输入商品卖点"></el-input>
			...
			<el-form-item label="所在地">
				...
				<el-select placeholder="请选择分类">
					<el-option label="青岛市" value="shanghai"></el-option>
				</el-select>
				<el-select placeholder="请选择分类">
					<el-option label="城阳区" value="shanghai"></el-option>
				</el-select>
			</el-form-item>
...
<script>
	...
	import { Admin, Goods, Category } from '@/api/index.js'
